                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <select name="saleman" id="saleman">
                            ...
                            <?php if(is_array($saleman)): foreach($saleman as $key=>$value): ?><option value="<?php echo ($value["salemanid"]); ?>"><?php echo ($value["saleman"]); ?>(<?php echo ($value["phone"]); ?>)</option><?php endforeach; endif; ?>
                        </select>
                    </div>
                    <div class="layui-input-inline">
