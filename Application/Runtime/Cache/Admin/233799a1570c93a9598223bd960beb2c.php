        ...
        <div class="fadeInUp animated">
            <div id="form-list" class="layui-form">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input id="orderCode" type="text" name="orderCode" placeholder="输入订单号" value="" class="layui-input" style="width:300px;">
                    </div>
                    <div class="layui-input-inline">
...
<script type="text/javascript">
    ...
    function fenye(page){
      $.ajax({
        ...
        data: {saleman:saleman,firsttime:firsttime,lasttime:lasttime,page:page,orderCode:orderCode},
        dataType: "json",
        success:function(data){
            //$('#an').text(data[0]);
            $('#body').empty();
            ...
            for(key in order){
                ...
                tableHtml += '<tr><td class="layui-elip" title="'+order[key]['ordercode']+'">'+order[key]['ordercode']+'</td><td class="layui-elip">'+order[key]['saleman']+'</td><td class="layui-elip">'+order[key]['phone']+'</td><td class="layui-elip" title="'+order[key]['address']+'">'+order[key]['address']+'</td>';
                var detail = '';
                for(var i=0;i<order[key]['detail'].length;i++){
                    ...
                    if (i!=order[key]['detail'].length-1) {
                        detail += '<br/>';
                    }
                }
    ...
    $('#body').on('click','.orderUpdate',function(){
        ...
        window.location.href="/luomansi/index.php/Admin/Order/update/mod/index/id/"+id;
    });
