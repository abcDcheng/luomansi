                    ...
                    <section class="sc_layout_inner layui-clear">
                        <div class="sc_editor_content">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="goodsCode" class="layui-input" autocomplete="off" placeholder="请输入产品识别码" datatype="s4-30" errormsg="请输入正确的产品识别码" nullmsg="请输入产品识别码!">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    ...
                                    <input name="install" type="radio" value="0" title="未安装" checked="checked"/>
                                </div>
                            </div>
                        </div>
                    </section>
