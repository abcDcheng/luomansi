                ...
                <div class="fadeInUp animated">
                    <section class="sc_layout_inner layui-clear">
                        <div class="sc_editor_content">
                            ...
                            <div class="layui-form-item">
                                <label class="layui-form-label label-required">产品识别码</label>
                                <div class="layui-input-block">
                                    <input type="text" name="goodsCode" class="layui-input" autocomplete="off" placeholder="请输入产品识别码" datatype="s2-30" errormsg="请输入正确的产品识别码" nullmsg="请输入产品识别码!" value="<?php echo ($info['goodscode']); ?>">
                                    <input name="oldCode" type="hidden" value="<?php echo ($info['goodscode']); ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label label-required">安装状态</label>
                                <div class="layui-input-block">
                                    <?php if($info['install'] == 1): ?><input name="install" type="radio" value="1" title="已安装" checked="checked"/>
                                    <input name="install" type="radio" value="0" title="未安装"/>
                                    <?php else: ?>
                                    <input name="install" type="radio" value="1" title="已安装"/>
                                    <input name="install" type="radio" value="0" title="未安装" checked="checked"/><?php endif; ?>
                                </div>
                            </div>
                        </div>
                    </section>
