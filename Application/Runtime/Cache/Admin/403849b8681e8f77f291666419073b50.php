...
<div class="layui-layout-admin">
    ...
    <div class="layui-body" id="sc_body">
        ...
        <img id="logo" src="/luomansi/Application/Admin/Public/images/logo.png" style="width: 100px;height: 30px;margin-left: 5px;">
            ...
            <?php if($group == 99 or $group == 4): ?><a class="layui-btn layui-btn-sm" href="<?php echo U('Code/add');?>"><i class="layui-icon"></i> 新增</a> &nbsp;<a class="layui-btn layui-btn-sm" href="<?php echo U('Code/import');?>"><i class="layui-icon"></i> 批量导入</a><?php endif; ?>
            </div>
        </div>
        <div class="fadeInUp animated">
            <div id="form-list" class="layui-form">
                ...
                <?php if($group == 99): ?><div class="layui-inline" style="float: right;">
                    ...
                    <?php if($open == 1): ?><input name="scan" type="checkbox" value="1" lay-skin="switch" lay-text="开|关" checked="checked" lay-filter="scan">
                    <?php else: ?>
                        <input name="scan" id="scan" type="checkbox" value="1" lay-skin="switch" lay-text="开|关" lay-filter="scan"><?php endif; ?>
                    </div>
                </div><?php endif; ?>
