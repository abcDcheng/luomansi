...
<div class="layui-layout-admin">
    ...
    <div class="layui-body" id="sc_body">
        <div class="sc_body">
            <form action="<?php echo U('Admin/serviceUpdate');?>" id="form" class="layui-form layui-form-pane">
                ...
                <div class="fadeInUp animated">
                    <section class="sc_layout_inner layui-clear">
                        <div class="sc_editor_content">
                            ...
                            <input name="salemanId" value="<?php echo ($info["salemanid"]); ?>" type="hidden"/>
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input id="idcard" type="text" name="IDcard" placeholder="身份证" class="layui-input" autocomplete="off" datatype="*18-18" errormsg="请输入正确身份证" nullmsg="请输入身份证!" value="<?php echo ($info["idcard"]); ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                <label class="layui-form-label label-required">状态</label>
                                <div class="layui-input-block">
                                    <?php if($info['status'] == 1): ?><input name="status" type="radio" value="1" title="使用中" checked="checked"/>
