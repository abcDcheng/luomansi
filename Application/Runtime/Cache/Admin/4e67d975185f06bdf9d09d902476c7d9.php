                    ...
                    <section class="sc_layout_inner layui-clear">
                        <div class="sc_editor_content">
                            ...
                            <div class="layui-form-item">
                                ...
                                <div class="layui-input-block">
                                    <input type="text" name="address" class="layui-input" autocomplete="off" datatype="*2-255" errormsg="请输入正确的送货地址" placeholder="送货地址" nullmsg="请输入送货地址!" value="<?php echo ($info["address"]); ?>">
                                </div>
                            </div>
                            <div class="layui-form-item">
                                ...
                                <div style="
                                    ...
                                    <?php if(is_array($model)): foreach($model as $key=>$value): echo ($value["goodsname"]); ?>-<?php echo ($value["goodsmodel"]); ?>&nbsp;×&nbsp;<?php echo ($value["goodsnum"]); ?><br/><?php endforeach; endif; ?>
                                    </div>
                                </div>
                            </div>
                            <div class="layui-form-item">
