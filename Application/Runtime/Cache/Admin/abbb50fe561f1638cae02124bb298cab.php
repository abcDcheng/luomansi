        ...
        <div class="fadeInUp animated">
            <div id="form-list" class="layui-form">
                ...
                <div class="layui-inline">
                    <div class="layui-input-inline">
                        <input id="goodsCode" type="text" name="goodsCode" placeholder="输入产品识别码" value="" class="layui-input" style="width:250px;">
                    </div>
                    <div class="layui-input-inline">
...
<script type="text/javascript">
    $(function(){
        ...
        $('#cx').click(function(){
            ...
            if (goodsCode && !re.test(goodsCode)) {
                alert('产品识别码不能带特殊符号');
                return false;
            }
            saleman = $('#saleman').val();
    ...
    function fenye(page){
      $.ajax({
        ...
        data: {saleman:saleman,firsttime:firsttime,lasttime:lasttime,page:page,ischecked:ischecked,goodsCode:goodsCode},
        dataType: "json",
        success:function(data){
            $('#an').text(data[0]);
            $('#body').empty();
